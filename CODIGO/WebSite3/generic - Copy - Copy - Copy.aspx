<%@ Page Language="C#" AutoEventWireup="true" CodeFile="generic - Copy - Copy - Copy.aspx.cs" Inherits="generic" %>
...
<html>
	...
	<body>
		...
		<!-- Footer -->
			<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Cerrar Sesion" Width="1038px" />
			<footer id="footer">
				>
				<div class="copyright">
