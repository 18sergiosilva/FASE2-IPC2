<%@ Page Language="C#" AutoEventWireup="true" CodeFile="depositoEfectivo.aspx.cs" Inherits="depositoEfectivo" %>

<!DOCTYPE html>

<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Deposito Efectivo</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <!-- Header -->
    <header id="header">
        <a href="index.html" class="logo"><strong>Deposito Efectivo</strong> Banca en Linea</a>
        <nav>
            <a href="#menu">Menu</a>
        </nav>
    </header>
        ...
        <div class="inner">
            ...
            <header>
                ...
                <div>
                    <ul class="actions">
                        <li>
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Deposito Efectivo" Width="969px" />
                        </li>
                    </ul>
                </div>
